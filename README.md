# Frontend Lab - HTML Canvas

![Design preview for the HTML Canvas frontend assessment](./preview.png)
...
**To do this challenge, you need a good understanding of React, JavaScript, HTML Canvas and CSS.**

## The challenge

Your challenge is to build a HTML Canvas using React.
...
- Your task is to implement a simple canva like editor with vanilla HTML Canvas, where
users can select an image which will be placed in a mask within the canvas
- Users will be able to change the caption text and call to action with a text input
- The user can also change the background color of the template. The template data will
be provided
- Implement the canvas functionality using Classes and OOPS concepts.
- Don’t use any library like fabric.js etc. Use React (functional component) and Vanilla
HTML Canvas (implement this with class)
- We like to use Tailwind CSS but feel free to use any UI libraries of your choice.
- For more information please visit this [drive link](https://drive.google.com/file/d/1Xs8Du5AdKpIuQa746UveKSFge7THLwKR/view)
- For reference you can try the demo [here](https://canva-editor-tau.vercel.app)
